...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'egulias.answer.listener' => 'getEgulias_Answer_ListenerService',
            'egulias.question.manager' => 'getEgulias_Question_ManagerService',
            'egulias.quiz.manager' => 'getEgulias_Quiz_ManagerService',
            'egulias.take.quiz' => 'getEgulias_Take_QuizService',
            ...
            'sonata.admin.faq' => 'getSonata_Admin_FaqService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MyAppUlearnBundle', ($this->targetDirs[2].'/Resources/MyAppUlearnBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MyAppUlearnBundle', ($this->targetDirs[3].'\\src\\MyApp\\UlearnBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['dcs_rating.manager.rating.default'] = new \DCS\RatingBundle\Entity\RatingManager($this->get('debug.event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'MyApp\\UlearnBundle\\Entity\\Rating');
    }
    ...
    {
        return $this->services['dcs_rating.manager.vote.default'] = new \DCS\RatingBundle\Entity\VoteManager($this->get('debug.event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'MyApp\\UlearnBundle\\Entity\\Vote');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'prePersist'), $this->get('egulias.answer.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'piuniversity', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array('bit' => 'boolean'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MyApp\\UlearnBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\University\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Symf\\GrapheBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Symf\\MyBundle\\Entity'), 4 => ($this->targetDirs[3].'\\vendor\\undf\\quiz-bundle\\Egulias\\QuizBundle\\Entity')));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\damianociarla\\rating-bundle\\DCS\\RatingBundle\\Resources\\config\\doctrine') => 'DCS\\RatingBundle\\Entity'));
        $c->setGlobalBasename('mapping');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Admin\\AdminBundle\\Resources\\config\\doctrine') => 'Admin\\AdminBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $e->addDriver($b, 'MyApp\\UlearnBundle\\Entity');
        $e->addDriver($b, 'University\\UserBundle\\Entity');
        $e->addDriver($b, 'Symf\\GrapheBundle\\Entity');
        $e->addDriver($b, 'Symf\\MyBundle\\Entity');
        $e->addDriver($b, 'Egulias\\QuizBundle\\Entity');
        $e->addDriver($c, 'DCS\\RatingBundle\\Entity');
        ...
        $f->setEntityNamespaces(array('MyAppUlearnBundle' => 'MyApp\\UlearnBundle\\Entity', 'UniversityUserBundle' => 'University\\UserBundle\\Entity', 'DCSRatingBundle' => 'DCS\\RatingBundle\\Entity', 'AdminAdminBundle' => 'Admin\\AdminBundle\\Entity', 'SymfGrapheBundle' => 'Symf\\GrapheBundle\\Entity', 'SymfMyBundle' => 'Symf\\MyBundle\\Entity', 'EguliasQuizBundle' => 'Egulias\\QuizBundle\\Entity'));
    ...
    /**
     * Gets the 'egulias.answer.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Egulias\QuizBundle\Listener\Doctrine\AnswerEvents A Egulias\QuizBundle\Listener\Doctrine\AnswerEvents instance.
     */
    protected function getEgulias_Answer_ListenerService()
    {
        return $this->services['egulias.answer.listener'] = new \Egulias\QuizBundle\Listener\Doctrine\AnswerEvents();
    }

    /**
     * Gets the 'egulias.question.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Egulias\QuizBundle\Form\Manager\QuestionFormManager A Egulias\QuizBundle\Form\Manager\QuestionFormManager instance.
     * 
     * @throws InactiveScopeException when the 'egulias.question.manager' service is requested while the 'request' scope is not active
     */
    protected function getEgulias_Question_ManagerService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('egulias.question.manager', 'request');
        }

        return $this->services['egulias.question.manager'] = $this->scopedServices['request']['egulias.question.manager'] = new \Egulias\QuizBundle\Form\Manager\QuestionFormManager($this->get('request'), $this->get('doctrine.orm.default_entity_manager'), $this->get('form.factory'));
    }

    /**
     * Gets the 'egulias.quiz.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Egulias\QuizBundle\Form\Manager\QuizFormManager A Egulias\QuizBundle\Form\Manager\QuizFormManager instance.
     * 
     * @throws InactiveScopeException when the 'egulias.quiz.manager' service is requested while the 'request' scope is not active
     */
    protected function getEgulias_Quiz_ManagerService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('egulias.quiz.manager', 'request');
        }

        return $this->services['egulias.quiz.manager'] = $this->scopedServices['request']['egulias.quiz.manager'] = new \Egulias\QuizBundle\Form\Manager\QuizFormManager($this->get('request'), $this->get('doctrine.orm.default_entity_manager'), $this->get('form.factory'));
    }

    /**
     * Gets the 'egulias.take.quiz' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Egulias\QuizBundle\Form\Manager\TakeQuizFormManager A Egulias\QuizBundle\Form\Manager\TakeQuizFormManager instance.
     * 
     * @throws InactiveScopeException when the 'egulias.take.quiz' service is requested while the 'request' scope is not active
     */
    protected function getEgulias_Take_QuizService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('egulias.take.quiz', 'request');
        }

        return $this->services['egulias.take.quiz'] = $this->scopedServices['request']['egulias.take.quiz'] = new \Egulias\QuizBundle\Form\Manager\TakeQuizFormManager($this->get('request'), $this->get('doctrine.orm.default_entity_manager'), $this->get('form.factory'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('University\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('University\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('University\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('University\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'University\\UserBundle\\Entity\\User');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle\\Sensio\\Bundle\\FrameworkExtraBundle/Resources/config/serializer'), 'MyApp\\UlearnBundle' => ($this->targetDirs[3].'\\src\\MyApp\\UlearnBundle/Resources/config/serializer'), 'University\\UserBundle' => ($this->targetDirs[3].'\\src\\University\\UserBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/config/serializer'), 'DCS\\RatingBundle' => ($this->targetDirs[3].'\\vendor\\damianociarla\\rating-bundle\\DCS\\RatingBundle/Resources/config/serializer'), 'Admin\\AdminBundle' => ($this->targetDirs[3].'\\src\\Admin\\AdminBundle/Resources/config/serializer'), 'Sonata\\CoreBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle/Resources/config/serializer'), 'Sonata\\BlockBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle/Resources/config/serializer'), 'Knp\\Bundle\\MenuBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-menu-bundle\\Knp\\Bundle\\MenuBundle/Resources/config/serializer'), 'Sonata\\DoctrineORMAdminBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\doctrine-orm-admin-bundle/Resources/config/serializer'), 'Sonata\\AdminBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle/Resources/config/serializer'), 'Ob\\HighchartsBundle' => ($this->targetDirs[3].'\\vendor\\ob\\highcharts-bundle/Resources/config/serializer'), 'Symf\\GrapheBundle' => ($this->targetDirs[3].'\\src\\Symf\\GrapheBundle/Resources/config/serializer'), 'Symf\\MyBundle' => ($this->targetDirs[3].'\\src\\Symf\\MyBundle/Resources/config/serializer'), 'Egulias\\QuizBundle' => ($this->targetDirs[3].'\\vendor\\undf\\quiz-bundle\\Egulias\\QuizBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'Nomaya\\SocialBundle' => ($this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle/Resources/config/serializer'), 'MyApp\\MailBundle' => ($this->targetDirs[3].'\\src\\MyApp\\MailBundle/Resources/config/serializer'), 'Knp\\Bundle\\SnappyBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-snappy-bundle\\Knp\\Bundle\\SnappyBundle/Resources/config/serializer'), 'Acme\\DemoBundle' => ($this->targetDirs[3].'\\src\\Acme\\DemoBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle\\Sensio\\Bundle\\GeneratorBundle/Resources/config/serializer')));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \University\UserBundle\Redirection\AfterLoginRedirection A University\UserBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \University\UserBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/homeAd/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/homeEns');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/uploadcours');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/homeEt');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/homeCh');
        ...
        $p->add($l, array(0 => 'ROLE_ENSEIGNANT'), NULL);
        $p->add($m, array(0 => 'ROLE_ENSEIGNANT'), NULL);
        $p->add($n, array(0 => 'ROLE_ETUDIANT'), NULL);
        $p->add($o, array(0 => 'ROLE_CHEFENTREPRISE'), NULL);

        $q = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $r = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $q, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($q, '/home'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $r->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $r, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $q, 'main', $this->get('redirect.after.login'), new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $q, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '552527155c4ff', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $p, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $q, '/login', false), NULL, NULL, $a));
    }
    ...
    /**
     * Gets the 'sonata.admin.faq' service.
     *
     * @return \Admin\AdminBundle\Admin\FaqAdmin A Admin\AdminBundle\Admin\FaqAdmin instance.
     */
    protected function getSonata_Admin_FaqService()
    {
        $instance = new \Admin\AdminBundle\Admin\FaqAdmin('sonata.admin.faq', 'Admin\\AdminBundle\\Entity\\Faq', 'SonataAdminBundle:CRUD');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.user', 1 => 'sonata.admin.faq'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.user', 1 => 'sonata.admin.faq'))));
        $instance->setAdminClasses(array('Admin\\AdminBundle\\Entity\\User' => array(0 => 'sonata.admin.user'), 'Admin\\AdminBundle\\Entity\\Faq' => array(0 => 'sonata.admin.faq')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.user', 1 => 'sonata.admin.faq'), $this);
    }
     ...
     *
     * @return \Admin\AdminBundle\Admin\UserAdmin A Admin\AdminBundle\Admin\UserAdmin instance.
     */
    protected function getSonata_Admin_UserService()
    {
        $instance = new \Admin\AdminBundle\Admin\UserAdmin('sonata.admin.user', 'Admin\\AdminBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('virtualuniversity3a8');
        $a->setPassword('chaimaabdouli10');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\MyApp\\UlearnBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\University\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Symf\\GrapheBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Symf\\MyBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\MyApp\\MailBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'MyAppUlearnBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MyApp\\UlearnBundle/Resources/views'), 'MyAppUlearn');
        $instance->addPath(($this->targetDirs[3].'\\src\\University\\UserBundle/Resources/views'), 'UniversityUser');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Symf\\GrapheBundle/Resources/views'), 'SymfGraphe');
        $instance->addPath(($this->targetDirs[3].'\\src\\Symf\\MyBundle/Resources/views'), 'SymfMy');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\undf\\quiz-bundle\\Egulias\\QuizBundle/Resources/views'), 'EguliasQuiz');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle/Resources/views'), 'NomayaSocial');
        $instance->addPath(($this->targetDirs[3].'\\src\\MyApp\\MailBundle/Resources/views'), 'MyAppMail');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ENSEIGNANT' => array(0 => 'ROLE_USER'), 'ROLE_ETUDIANT' => array(0 => 'ROLE_USER'), 'ROLE_CHEFENTREPRISE' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyAppUlearnBundle' => 'MyApp\\UlearnBundle\\MyAppUlearnBundle',
                'UniversityUserBundle' => 'University\\UserBundle\\UniversityUserBundle',
                ...
                'SymfGrapheBundle' => 'Symf\\GrapheBundle\\SymfGrapheBundle',
                'SymfMyBundle' => 'Symf\\MyBundle\\SymfMyBundle',
                'EguliasQuizBundle' => 'Egulias\\QuizBundle\\EguliasQuizBundle',
                'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle',
                'NomayaSocialBundle' => 'Nomaya\\SocialBundle\\NomayaSocialBundle',
                'MyAppMailBundle' => 'MyApp\\MailBundle\\MyAppMailBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'piuniversity',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'ranyahammouda92@gmail.com',
            'mailer_password' => 'Zertyuiop123',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'virtualuniversity3a8',
            'swiftmailer.mailer.default.transport.smtp.password' => 'chaimaabdouli10',
            ...
            'fos_user.model.user.class' => 'University\\UserBundle\\Entity\\User',
            ...
            'dcs_rating.model.rating.class' => 'MyApp\\UlearnBundle\\Entity\\Rating',
            'dcs_rating.model.vote.class' => 'MyApp\\UlearnBundle\\Entity\\Vote',
            ...
            'egulias_quiz_manager.class' => 'Egulias\\QuizBundle\\Form\\Manager\\QuizFormManager',
            'egulias_take_quiz_manager.class' => 'Egulias\\QuizBundle\\Form\\Manager\\TakeQuizFormManager',
            'egulias_question_manager.class' => 'Egulias\\QuizBundle\\Form\\Manager\\QuestionFormManager',
            'egulias_answer_events.class' => 'Egulias\\QuizBundle\\Listener\\Doctrine\\AnswerEvents',
            ...
            'buttons.facebook' => array(
                'url' => 'https://www.facebook.com/U.Learn.By.Xcoders',
                'locale' => 'fr_FR',
                'send' => false,
                'width' => 300,
                'showFaces' => false,
            ...
            'buttons.twitter' => array(
                ...
                'text' => 'Tweet',
                'via' => 'virtual_university ',
                'tag' => 'virtual_university',
                'showFaces' => false,
                'send' => true,
                'share' => true,
            ),
