...
namespace Proxies\__CG__\University\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \University\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'University\\UserBundle\\Entity\\User' . "\0" . 'sexe', '' . "\0" . 'University\\UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'University\\UserBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'University\\UserBundle\\Entity\\User' . "\0" . 'naissance', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function getNaissance()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNaissance', array());
    ...
    public function setNaissance($naissance)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNaissance', array($naissance));
