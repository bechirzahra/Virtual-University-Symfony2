...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['dcs_rating.manager.rating.default'] = new \DCS\RatingBundle\Entity\RatingManager($this->get('event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'MyApp\\UlearnBundle\\Entity\\Rating');
    }
    protected function getDcsRating_Manager_Vote_DefaultService()
    {
        return $this->services['dcs_rating.manager.vote.default'] = new \DCS\RatingBundle\Entity\VoteManager($this->get('event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'MyApp\\UlearnBundle\\Entity\\Vote');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'prePersist'), $this->get('egulias.answer.listener'));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'piuniversity', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('bit' => 'boolean'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b3e4889ffc15d94c920680f10520a3fdf6a8ecf1eef15024444a6f5cbfb85a90');
        return $instance;
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/homeEns');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'MyAppUlearnBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ENSEIGNANT' => array(0 => 'ROLE_USER'), 'ROLE_ETUDIANT' => array(0 => 'ROLE_USER'), 'ROLE_CHEFENTREPRISE' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
