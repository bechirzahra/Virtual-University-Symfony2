...
use MyApp\UlearnBundle\Entity\QuizQuestion;
use MyApp\UlearnBundle\Form\QuizQuestionType;
...
class QuizQuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MyAppUlearnBundle:QuizQuestion')->findAll();
     ...
     *
     * @Route("/", name="quizquestion_create")
     * @Method("POST")
     * @Template("MyAppUlearnBundle:QuizQuestion:new.html.twig")
     */
     ...
     *
     * @Route("/new", name="quizquestion_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="quizquestion_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyAppUlearnBundle:QuizQuestion')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="quizquestion_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="quizquestion_update")
     * @Method("PUT")
     * @Template("MyAppUlearnBundle:QuizQuestion:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}", name="quizquestion_delete")
     * @Method("DELETE")
     */
